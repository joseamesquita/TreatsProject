    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TreatsFlavorId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FlavorId = table.Column<int>(nullable: false),
                    TreatId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreatsFlavor", x => x.TreatsFlavorId);
                    table.ForeignKey(
                        name: "FK_TreatsFlavor_Flavors_FlavorId",
                        column: x => x.FlavorId,
                        principalTable: "Flavors",
                        principalColumn: "FlavorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatsFlavor_Treats_TreatId",
                        column: x => x.TreatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatsFlavor_FlavorId",
                table: "TreatsFlavor",
                column: "FlavorId");

            migrationBuilder.CreateIndex(
                name: "IX_TreatsFlavor_TreatId",
                table: "TreatsFlavor",
                column: "TreatId");
        }
